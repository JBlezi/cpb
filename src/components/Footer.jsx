        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="mb-2">Munich, 80331</p>
              <p className="mb-2">Phone: +49 123 456 789</p>
              <p>Email: contact@drjohnson.com</p>
            </div>
            
            <div>
              <h3 className="text-xl mb-4 font-light">Office Hours</h3>
            ...
            <div>
              <h3 className="text-xl mb-4 font-light">Follow Me</h3>
          ...
          <div className="mt-12 pt-8 border-t border-blue-800 flex flex-col md:flex-row justify-between items-center">
            ...
            <nav>
              <ul className="flex flex-wrap justify-center space-x-6">
                <li><Link to="/privacy" className="text-sm text-blue-200 hover:text-white transition">Privacy Policy</Link></li>
                <li><Link to="/imprint" className="text-sm text-blue-200 hover:text-white transition">Imprint</Link></li>
                <li><a href="#" className="text-sm text-blue-200 hover:text-white transition">Accessibility</a></li>
              </ul>
            </nav>
          </div>
        </div>
